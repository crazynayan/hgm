...
class Config:
    ...
    TBD = "To Be Decided"
    GROUP_TO_QUALIFIERS = {
        GROUP_A: QUARTERFINAL_1,
        GROUP_B: QUARTERFINAL_2,
        GROUP_C: QUARTERFINAL_3,
        GROUP_D: QUARTERFINAL_4,
    }
    GROUP_TO_DECIDERS = {
        GROUP_A: QUARTERFINAL_4,
        GROUP_B: QUARTERFINAL_3,
        GROUP_C: QUARTERFINAL_2,
        GROUP_D: QUARTERFINAL_1,
    }
    REGION_CHANGE = (QUARTERFINAL_4, FINAL)
    GROUP_REGION_CHANGE = (INITIAL_2, ELIMINATOR, DECIDER)
